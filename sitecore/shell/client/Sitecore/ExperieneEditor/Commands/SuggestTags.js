define(["sitecore", "/-/speak/v1/ExperienceEditor/ExperienceEditor.js", "/-/speak/v1/ExperienceEditor/ExperienceEditor.Context.js"], function (Sitecore, ExperienceEditor, EContext) {
    Sitecore.Commands.SuggestTags =
    {
	  ...
	  console.log(context);
          ...
          var dialogPath = "/sitecore/shell/client/Applications/SuggestTags/?fo=" + context.currentContext.itemId + "&la=" + context.currentContext.language + "&vs=" + context.currentContext.version + "&pa=2&mo=media";
